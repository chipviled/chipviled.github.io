...
var photoswipe_init = function () {
    function photoswipe_init(element) {
        _classCallCheck(this, photoswipe_init);

        var pw = document.createElement('div');
        pw.innerHTML = this.template_photoswipe();
        document.body.appendChild(pw);
        this.initPhotoSwipeFromDOM(element);
    }

    _createClass(photoswipe_init, [{
        key: 'template_photoswipe',
        value: function template_photoswipe() {
...
function work(data) {
    var template_iterations = document.getElementById("iterations");
    ...
    try {
        for (var _iterator = iterations_data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            var t_object = document.createElement('li');
