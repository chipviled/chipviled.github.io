...
jQuery.when(jQuery.getJSON('./data/json/picture.json' + '?v=' + config.v), jQuery.getJSON('./data/json/users.json' + '?v=' + config.v), jQuery.getJSON('./data/json/iteration.json' + '?v=' + config.v), jQuery.getJSON('./data/json/achivement.json' + '?v=' + config.v), jQuery.getJSON('./data/json/user_achivement.json' + '?v=' + config.v), jQuery.getJSON('./data/json/user_vote.json' + '?v=' + config.v)).done(function (picture, users, iteration, achivement, user_achivement, user_vote) {
    var data = {
        picture: picture[0],
        users: users[0],
